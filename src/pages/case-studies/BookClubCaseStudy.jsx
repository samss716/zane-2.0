  ...
  return (
    <main className="min-h-screen bg-white pt-20">
      <CaseStudyHero
        eyebrow="Case Study"
        title="Book Club App"
        subtitle="Designing a more social and intuitive reading experience through research, interaction design, and iterative prototyping."
        image="/media/web/cafe.jpg"
      />
