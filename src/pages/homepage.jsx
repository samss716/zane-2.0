export default function HomePage() {
  return (
    <main className="min-h-screen bg-[#fffbec] relative">
      {/* Hero Section */}
      <section className="relative h-[60vh] bg-gradient-to-r from-purple-500 to-indigo-600 flex items-center justify-center overflow-hidden">
      ...
      {/* Contact Section */}
      <section className="h-[50vh] flex items-center justify-center bg-[#0099ff] text-white">
